...
with tab2:
    ...
    if 'portfolio' in st.session_state:
        ...
        # Create betting recommendation tabs - 9개 탭으로 확장
        bet_tab1, bet_tab2, bet_tab3, bet_tab4, bet_tab5, bet_tab6, bet_tab7, bet_tab8, bet_tab9 = st.tabs([
            "Single Bets", 
            "2-Team Parlays", 
            "3-Team Parlays",
        ...
        # Random 2-Team Parlays 탭 (bet_tab7) - 새로운 탭 추가
        with bet_tab7:
            if portfolio['singles']:
                import random
                import itertools
                ...
                **Random 2-Team Parlays:**  
                ...
                # 3. 모든 가능한 2-팀 조합 생성 (nC2)
                all_combos = list(itertools.combinations(range(len(picks)), 2))
                st.write(f"Total possible 2-team combinations: {len(all_combos)}")
                ...
                for combo in shuffled_combos:
                    ...
                    if can_add:
                        ...
                        boosted_odds = 1 + ((odds - 1) * 1.10)  # 10% 부스트 (2팀은 더 작은 부스트)
        ...
        # Random 3-Team Parlays 탭 (bet_tab8)
        with bet_tab8:
            if portfolio['singles']:
                import random
                import itertools
        ...
        # Random 4-Team Parlays 탭 (bet_tab9)
        with bet_tab9:
            if portfolio['singles']:
                import random
                import itertools
