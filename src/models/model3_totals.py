# src/models/model3_totals.py
# XGBoost Regressor - Total Score Prediction
import pandas as pd
import numpy as np
...
class BettingModel3Totals:
    ...
    def train_model(self, X: pd.DataFrame, y: pd.Series, params: Dict = None) -> Dict:
        ...
        print("\n=== Model3 Totals (XGBoost Regressor) 학습 시작 ===")
    ...
    def save_model(self, timestamp: str = None) -> None:
        ...
        # 모델 파일 경로
        model_path = self.model_dir / f"totals_model3_{timestamp}.joblib"
        feature_path = self.model_dir / f"totals_features3_{timestamp}.json"
